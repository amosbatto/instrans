...
"Commentario es afuera del orden correcto de PO."=>
"Comment is out of the correct PO order.",

#: instrans.php:298
"No hay un msgid definido para este texto." =>
"There is no defined msgstr for this text.",

#: instrans.php:304
"Línea no termina en comillas." =>
"Line does not end in double quotes.",

"domain es definido afuera del orden correcto de PO."=>
"domain is defined out of the correct PO order.",

"domain no está encerrado en comillas." =>
"domain is not enclosed in double quotes.",

"domain no es definido correctamente."=>
"domain is not defined correctly.",

"msgid es definido afuera del orden correcto de PO."=>
"msgid is defined out of the correct PO order.", 

"msgid_plural es definido afuera del orden correcto de PO."=>
"msgid_plural is defined out of the correct PO order.",

"msgid no está encerrado en comillas." =>
"msgid is not enclosed in double quotes.",
...
#: instrans.php:344
"msgid no es definido correctamente." =>
"The msgid is not defined correctly.",

#: instrans.php:367
"msgstr no está encerrado en comillas." =>
"msgstr is not enclosed in double quotes.",

#: instrans.php:372
"msgstr no es definido correctamente." =>
"msgstr is not defined correctly.",
...
"Error: \"%s\" no es un argumento valido." =>
...
#: instrans.php:1107
#, php-format
"Aviso: Archivo \"%s\" no contiene ningunos objetos PO.\n" =>
"Warning: File \"%s\" does not have any PO objects.\n",

#: instrans.php:1110
#, php-format
"Error: Archivo \"%s\" no contiene ningunos objetos PO." =>
"Error: File \"%s\" does not have any PO objects.",
...
"%d lines and %d PO objects written in file \"%s\"\n",
...
#: instrans.php:1677
"Error: No puede abrir el archivo \"help-es.txt\".\n" =>
"Error: Unable to open the file \"help-en.txt\".\n"
